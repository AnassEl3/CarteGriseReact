...
import { faArrowLeft, faArrowRight, faCar, faCircleXmark, faEye, faFileLines, faMagnifyingGlass, faPen, faPlus, faTrash } from '@fortawesome/free-solid-svg-icons';
...
function ListeDemandes() {
    ...
    const handleDeleteDemande = (
        ...
        const demandeId = e.target.getAttribute("data-demandeId");
        console.log(demandeId);
        
        api.delete(`demandes/${demandeId}`)
            .then((res) => {
                toast.success("Demande a été supprimé avec succès");
                loadData();
    ...
    const loadData = () => {
        pageLoadingHolder.setPageLoading(true);
        api.get(`demandes?size=5&page=${page}&sort=id,desc`)
            .then((res) => {
                const demandes: Demande[] = res.data._embedded.demandes;
  ...
  return (
    <PageLayout>
            <PageHeader title="Liste des demandes" icon={faFileLines}>
                <Alink href="/app/demandes/add" color="success" icon={faPlus}>
                    Ajouter demande
                </Alink>
            </PageHeader>
                                ...
                                >
                                    ...
                                    <td className="h-px w-px whitespace-nowrap text-center p-2">
                                        <div className="flex flex-wrap justify-center items-center">
                                            ...
                                            />
                                            <Alink
                                                href={`/app/demandes/${demande.id}/edit`}
                                                color="info"
                                                size="sm"
                                                icon={faPen}
                                                className="m-1"
                                            ...
                                            >
                                                ...
                                                <div className="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-gray-700">
                                                    <button
                                                        ...
                                                        data-hs-overlay={`#model-n${demande.id}`}
                                                        onClick={
                                                            handleDeleteDemande
                                                        }
                                                    >
